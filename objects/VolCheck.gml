...
draw_set_valign(2)
draw_set_halign(2)
draw_text(global.width-16,global.height-16,"Volume Check#["+key_get_name(global.keycode[key_jump])+"] to confirm")
draw_set_halign(0)
draw_text(16,global.height-16,"Sound Volume: "+string(round(settings("sfxvol")*100))+"%#Use ["+key_get_name(global.keycode[key_up])+"] and ["+key_get_name(global.keycode[key_down])+"]")
draw_set_valign(0)
